...
SIZE_PRESETS = {
    "素材のまま": (None, "素材のまま"),
    "680 × 450（横長・記事メイン）": ((680, 450), "680×450"),
    "680 × 800（縦長・強調）": ((680, 800), "680×800"),
    "1080 × 1080（正方形・SNS）": ((1080, 1080), "1080×1080"),
    "1080 × 1920（縦動画・ストーリーズ）": ((1080, 1920), "1080×1920"),
    "1280 × 720（横動画）": ((1280, 720), "1280×720"),
}
